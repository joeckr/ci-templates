...
get_checksum() {
  ...
  current_version="v2026.9.5"
  current_version="${current_version#v}"

  # For current version use static checksum otherwise
  # use checksum from releases
  if [ "$version" = "$current_version" ]; then
    checksum_linux_x86_64="d71e94e1ed59d4d0ca4ac847fa321d6d6615a8e613e9b468c9fb39f0dddd06d5  ./mise-v2026.9.5-linux-x64.tar.gz"
    checksum_linux_x86_64_musl="6f0445ef390b60f8de2fdefc15cc69997faacdf75bb9fc113593879269054b17  ./mise-v2026.9.5-linux-x64-musl.tar.gz"
    checksum_linux_arm64="3a52c7c7c58d21a0791516950ebf4bc915f403277b49c93d657fc585259625ec  ./mise-v2026.9.5-linux-arm64.tar.gz"
    checksum_linux_arm64_musl="7915fb3089cb03919fb93c8c629ed065fe30c7cf8e797d9a58c8a70853f44d7e  ./mise-v2026.9.5-linux-arm64-musl.tar.gz"
    checksum_linux_armv7="e70148347b38e98803dfba9938f17e9808cdea166d5cae3120d6e2378c850c9d  ./mise-v2026.9.5-linux-armv7.tar.gz"
    checksum_linux_armv7_musl="49d8e48e75961f1306a22da0993308294beea7a5ff165ff2e0ad46092f037fa4  ./mise-v2026.9.5-linux-armv7-musl.tar.gz"
    checksum_macos_x86_64="c31958952868b7b37ec6a5f46ee1a82d1382470bf15f2c663e7cb35ac0acf88c  ./mise-v2026.9.5-macos-x64.tar.gz"
    checksum_macos_arm64="cb994f2e8a94fbf00300045c81ee799ffebcd8e78241ff37b0aa2da96b924aad  ./mise-v2026.9.5-macos-arm64.tar.gz"
    checksum_linux_x86_64_zstd="2d3c99a10e9729556ebf8ccdcd0298ce9566eebf3f197b598f0f9a2f88cdbe4b  ./mise-v2026.9.5-linux-x64.tar.zst"
    checksum_linux_x86_64_musl_zstd="e32705ab2d7d63434e7dd9313e5efa3011bcc3381acbe36913f3e9ebcc8cb578  ./mise-v2026.9.5-linux-x64-musl.tar.zst"
    checksum_linux_arm64_zstd="bf29c0eab421872ad157c34b6af70b5da64abd9b63025297778080f728fb4992  ./mise-v2026.9.5-linux-arm64.tar.zst"
    checksum_linux_arm64_musl_zstd="554dff3be55b24ad08353e491c80e449b1f27b105b31f7816d0e831894d73765  ./mise-v2026.9.5-linux-arm64-musl.tar.zst"
    checksum_linux_armv7_zstd="a2e04e0225e6f94e7ef21522b404478d7a5ab6feb174c7467ecfafc5d4c74d67  ./mise-v2026.9.5-linux-armv7.tar.zst"
    checksum_linux_armv7_musl_zstd="b7a67fa3d135f8d10d8f4a7244881cbac4839be6ff9048cd4d95c930fafaae70  ./mise-v2026.9.5-linux-armv7-musl.tar.zst"
    checksum_macos_x86_64_zstd="e4af8305e4b6dbbadf7ab84e7680b0d2f40a178c871b0b66421b97820d045af3  ./mise-v2026.9.5-macos-x64.tar.zst"
    checksum_macos_arm64_zstd="e7628a16e53187317536d2ff7d5b7bfef25504ad1e97471afdeb1bbe9e7ec4fe  ./mise-v2026.9.5-macos-arm64.tar.zst"
...
install_mise() {
  version="${MISE_VERSION:-v2026.9.5}"
  version="${version#v}"
  current_version="v2026.9.5"
  current_version="${current_version#v}"
